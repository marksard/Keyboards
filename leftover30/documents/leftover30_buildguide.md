...
| - | 1 | ケースパーツ | トップカバー</br>ボトムケース</br>ロータリーエンコーダーカバー</br>サイドアクリルパネル |
| - | 10 | インサートナット | ケース取り付け用 |
| - | 6 | M2 4mm | PCB用 |
| - | 2 | M2 6mm | ケース手前用 |
| - | 2 | M2 12mm | ケース奥側用 |
| - | 4 | - | ゴム脚 |
...
　はんだごての熱を利用して、ケースのビス留め位置にインサートナットを埋め込みます。取り付け位置は10個所あります。  
...
- 穴位置を確認する
- こて先をキレイにしてから、インサートナットの穴にこて先を入れて拾う
- ケースの穴が空いているところの中心にあわせて、垂直になるように、上からゆっくりとケースの穴の周りを溶かしながら入れる
- ナットの上面をケース面まで埋めたら、ピンセットでナットを押さえてこて先をはずす
- 冷えるまで30～60秒は待つ

　ケース素材でナットの周辺が盛り上がってしまった場合、完全に冷えてからニッパーなどで切り落としてください。  
　もし斜めだったり、穴位置がずれていたりする場合はもう一度はんだごてを当てて修正してください。  
　修正しすぎて穴が広がった場合、穴の周辺にはんだごてをあてて穴を少し狭めてからやりなおしてください。  

## アルチザン置き場のREカバーについて

　左下位置にはロータリーエンコーダーを取り付けた時に透けないように脱着可能なカバーが取り付けられます。ロータリーエンコーダーの場合は取り付けて、キースイッチを付ける場合は外してお使いください。  
...
あとはお好きなキーキャップと、ロータリーエンコーダーを取り付けている場合は好きなつまみを取り付けてください。  
