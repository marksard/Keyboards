...
2. QMK Toolboxの「Keyboard from qmk.fm」の下のリストからtreadstone48/rev1を選びます
...
[デフォルトhexファイル](https://qmk.fm/compiled/treadstone48_rev1_default.hex)  
...
```qmk compile -kb treadstone48/rev1 -km default```
で可能です。書き込む場合は
```qmk flash -kb treadstone48/rev1 -km default```  
