...
[キーマップ解説](https://github.com/marksard/qmk_firmware/tree/own_build/keyboards/treadstone32/keymaps/default/readme_jp.md)はこちら。日本語切り替えは(Layer1キー + B位置のキー)、Win/Mac切り替えは(Layer3キー + E位置のキーでmac向け、Layer3キー + R位置のキー)になっています。  
